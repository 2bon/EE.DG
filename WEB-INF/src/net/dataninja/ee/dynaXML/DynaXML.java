...
import net.dataninja.ee.lazyTree.PersistentTree;
import net.dataninja.ee.lazyTree.LazyProfilingListener;
...
public class DynaXML extends TextServlet 
{
  ...
  */
   ...
   * "net.dataninja.ee.DocLocatorClass" to see if there is a user-
  ...
  public DocLocator createDocLocator() 
  {
    ...
    final String propName = "net.dataninja.ee.DocLocatorClass";
