...
import net.dataninja.ee.servletBase.StylesheetCache;
...
import net.dataninja.ee.textEngine.XtfBigramQueryRewriter;
import net.dataninja.ee.textIndexer.TagFilter;
import net.dataninja.ee.textIndexer.TextIndexer;
import net.dataninja.ee.util.CircularQueue;
import net.dataninja.ee.util.DiskHashWriter;
import net.dataninja.ee.util.FastIntCache;
import net.dataninja.ee.util.FastCache;
import net.dataninja.ee.util.IntHash;
import net.dataninja.ee.util.IntMultiMap;
import net.dataninja.ee.util.Path;
import net.dataninja.ee.util.StructuredFile;
import net.dataninja.ee.util.StructuredStore;
import net.dataninja.ee.util.TagArray;
...
public class RegressTest 
{
    ...
    throws IOException 
  {
    ...
    // Set the ee.home property to the regression directory.
    System.setProperty("ee.home", dir);
