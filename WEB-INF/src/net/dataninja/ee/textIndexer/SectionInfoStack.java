 ...
 * while the {@link net.dataninja.ee.textIndexer.SectionInfo} class holds
...
public class SectionInfoStack 
{
   ...
   *  {@link net.dataninja.ee.textIndexer.SectionInfo} objects.
   */
   ...
   *                       {@link net.dataninja.ee.textIndexer#parentIndex parentIndex},
   *                       {@link net.dataninja.ee.textIndexer#index index},
   *                       {@link net.dataninja.ee.textIndexer#noIndex noIndex}.
   *                       <br><br>
   *
   ...
   *                       {@link net.dataninja.ee.textIndexer#parentSpell parentSpell},
   *                       {@link net.dataninja.ee.textIndexer#spell spell},
   *                       {@link net.dataninja.ee.textIndexer#noSpell noSpell}.
   *                       <br><br>
   *                       
   ...
   *       the {@link net.dataninja.ee.textIndexer.SectionInfoStack#push() depth-push}
   ...
   *       see the {@link net.dataninja.ee.textIndexer.SectionInfo SectionInfo}
   *       class. <br><br>
   */
   ...
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#depth depth} field of the
   *  {@link net.dataninja.ee.textIndexer.SectionInfo} class to maintain the
   ...
   *
   *  @return  Returns {@link net.dataninja.ee.textIndexer.SectionInfo#index index}
   *           or
   ...
   *  the {@link net.dataninja.ee.textIndexer.SectionInfo#indexFlag indexFlag}
   *  field in the {@link net.dataninja.ee.textIndexer.SectionInfo} class. <br><br>
   */
   ...
   *
   *  @return  Returns {@link net.dataninja.ee.textIndexer.SectionInfo#spell spell}
   *           or
   ...
   *  the {@link net.dataninja.ee.textIndexer.SectionInfo#spellFlag spellFlag}
   *  field in the {@link net.dataninja.ee.textIndexer.SectionInfo} class. <br><br>
   */
   ...
   *  the {@link net.dataninja.ee.textIndexer.SectionInfo#sectionType sectionType}
   *  field in the {@link net.dataninja.ee.textIndexer.SectionInfo} class. <br><br>
   */
   ...
   *           (if any), or the {@link net.dataninja.ee.textIndexer.SectionInfo#defaultSectionBump defaultSectionBump}
   *           value if the stack is empty. <br><br>
   *
   *  @.notes
   *  For a complete explanation of the <code>sectionBump</code> attribute, see
   *  the {@link net.dataninja.ee.textIndexer.SectionInfo#sectionBump sectionBump}
   *  field in the {@link net.dataninja.ee.textIndexer.SectionInfo} class. <br><br>
   */
   ...
   *  the {@link net.dataninja.ee.textIndexer.SectionInfo#wordBoost wordBoost}
   *  field in the {@link net.dataninja.ee.textIndexer.SectionInfo} class. <br><br>
   */
   ...
   *  the {@link net.dataninja.ee.textIndexer.SectionInfo#sentenceBump sentenceBump}
   *  field in the {@link net.dataninja.ee.textIndexer.SectionInfo} class. <br><br>
    */
  ...
  /** Push a {@link net.dataninja.ee.textIndexer.SectionInfo} instance onto the
