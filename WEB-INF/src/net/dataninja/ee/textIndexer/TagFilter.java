...
import net.dataninja.ee.util.Tester;
...
public class TagFilter extends TokenFilter 
{
  ...
  private Token processNext(Token curToken) 
  {
    ...
    // If no '=' found, keep scanning for the end of the setAttr name.
    if (srcChars[startPos] != '=')
      return null;
  ...
  public static final Tester tester = new Tester("TagFilter") 
  {
    ...
    protected void testImpl() 
    {
      try 
      {
        ...
        assert testFilter("<element setAttr=\"a\"/>").equals(
          ":!<element:@[setAttr:@a:@]setAttr:!>element:!/element");
        assert testFilter("<element setAttr=\"a b c\"/>").equals(
          ":!<element:@[setAttr:@a:@b:@c:@]setAttr:!>element:!/element");
        assert testFilter("<element setAttr=\"\"/>").equals(
          ":!<element:@[setAttr:@:@]setAttr:!>element:!/element");
