...
import net.dataninja.ee.lazyTree.LazyDocument;
import net.dataninja.ee.lazyTree.LazyKeyManager;
import net.dataninja.ee.lazyTree.LazyTreeBuilder;
...
import net.dataninja.ee.textEngine.XtfSearcher;
 ...
 *   <b><code>ee:sentencebump="</code><font color=#0000ff><i>xxx</i></font><code>"</code></b><br>
 ...
 *   is 5. <br><br>
 *
 *   <b><code>ee:sectiontype="</code><font color=#0000ff><i>xxx</i></font><code>"</code></b><br>
 ...
 *
 *   <b><code>ee:proximitybreak</code></b><br>
 ...
 *
 * <blockquote dir=ltr style="MARGIN-RIGHT: 0px">
 *   <b><code>ee:boost="</code><font color=#0000ff><i>xxx</i></font><code>"</code></b><br>
...
public class XMLTextProcessor extends DefaultHandler 
{
  ...
  */
   ...
   * {@link net.dataninja.ee.lazyTree.LazyTreeBuilder LazyTreeBuilder} class. <br><br>
   */
   ...
   *  description.
   */
  private static final String xtfUri = "http://dataninja.org/ee";
   ...
   *    are assumed to be prefixed by the namespace <code>ee</code>. <br><br>
   *
   ...
   
  {
    ...
    // If this is the start of a meta data node (marked with an ee:meta
    ...
    if (metaIndex >= 0 && ("yes".equals(metaVal) || "true".equals(metaVal))) 
    {
      ...
      // If there are non-ee attributes on the node, record them.
  ...
  /** Build a string representing any non-ee attributes in the given
   *  attribute list. This will be a series of name="value" pairs, separated
   *  by spaces. If there are no non-ee attributes, empty string is returned.
   *  <br><br>
   */
  ...
  private void processNodeAttributes(Attributes atts) 
  {
    ...
    for (int i = 0; i < atts.getLength(); i++) 
    {
      // Skip non-ee related attributes.
      ...
      // ee:xxxx attribute, display a warning message (if enabled for
      // output.)
      //
      else {
        Trace.tab();
        Trace.warning(
          "*** Warning: Unrecognized ee Attribute [ " + atts.getQName(i) +
          "=" + atts.getValue(i) + " ].");
        Trace.untab();
      }
    } // for( int i = 0; i < atts.getLength(); i++ )
  ...
  public void Wiki_title_extraction(String homePath )
  {
    open (homePath);
