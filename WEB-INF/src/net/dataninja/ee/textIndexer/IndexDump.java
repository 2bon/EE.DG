...
/**
 * This class dumps the contents of user-selected fields from an ee text
 * index.
 *
 * @author Rick Li
 */
public class IndexDump 
{
  ...
  public static void main(String[] args) 
  {
    try 
    {
      ...
      cfgInfo.xtfHomePath = System.getProperty("ee.home");
      if (cfgInfo.xtfHomePath == null || cfgInfo.xtfHomePath.length() == 0) {
        Trace.error("Error: ee.home property not found");
        return;
      }
      ...
      if (!new File(cfgInfo.xtfHomePath).isDirectory()) {
        Trace.error(
          "Error: ee.home directory \"" + cfgInfo.xtfHomePath +
    ...
    throws IOException 
  {
    ...
    for (int i = 0; i < maxDoc; i++) 
    {
      ...
      if (allFieldsMode) {
        ...
        {
          // Only output user fields (i.e. skip ee-internal fields)
  ...
  /**
   * Removes ee's special characters (such as bump markers and field start/end
