...
import net.dataninja.ee.cache.Dependency;
 ...
 *
 * Internally, this class uses the {@link net.dataninja.ee.textIndexer.XMLTextProcessor}
...
public class SrcTreeProcessor 
{
   ...
   *
   *  Instantiates the {@link net.dataninja.ee.textIndexer.XMLTextProcessor}
   ...
   *
   *  Calls the {@link net.dataninja.ee.textIndexer.XMLTextProcessor}
   *  {@link net.dataninja.ee.textIndexer.XMLTextProcessor#open(String, IndexInfo, boolean, boolean) open()}
   *  method to actually create/open the Lucene index.
   *
   *  @param cfgInfo   The {@link net.dataninja.ee.textIndexer#IndexerConfig IndexerConfig}
   ...
   *                       {@link net.dataninja.ee.textIndexer.XMLTextProcessor}
   *                       {@link net.dataninja.ee.textIndexer.XMLTextProcessor#open(String, IndexInfo, boolean, boolean) open()}
   *                       method. <br><br>
   */
    ...
    throws Exception 
  {
    ...
    // If no ee home directory specified, assume it is the same
   ...
   *
   *  Calls the {@link net.dataninja.ee.textIndexer.XMLTextProcessor}
   *  {@link net.dataninja.ee.textIndexer.XMLTextProcessor#processQueuedTexts() processQueuedTexts()}
   *  method to flush all the pending Lucene writes to disk. Then it calls the
   *  {@link net.dataninja.ee.textIndexer.XMLTextProcessor}
   *  {@link net.dataninja.ee.textIndexer.XMLTextProcessor#close() close()}
   ...
   *                       class or the {@link net.dataninja.ee.textIndexer.XMLTextProcessor}
   *                       class. <br><br>
   *
   */
