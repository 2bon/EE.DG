 ...
 * {@link net.dataninja.ee.textIndexer.SectionInfoStack }
...
public class SectionInfo 
{
   ...
   *  method defined by the {@link net.dataninja.ee.textIndexer.SectionInfoStack}
   *  class. That method in turn uses the parent section's index flag value,
   *  which will be either
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#index index} or
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#noIndex noIndex}.
   *  <br><br>
   */
   ...
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#indexFlag indexFlag} field
   ...
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#sectionBump sectionBump}
   ...
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#indexFlag indexFlag}
  ...
  *
  *  This is the default value applied to the
  *  {@link net.dataninja.ee.textIndexer.SectionInfo#sectionType sectionType}
  *  field whenever a <code>SectionInfo</code> class is constructed.
  *  <br><br>
  */
  ...
  *
  *  This is the default value applied to the
  *  {@link net.dataninja.ee.textIndexer.SectionInfo#subDocument subDocument}
  *  field whenever a <code>SectionInfo</code> class is constructed.
  *  <br><br>
  */
   ...
   *
   *  This is the default value applied to the
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#wordBoost wordBoost}
   *  field whenever a <code>SectionInfo</code> class is constructed.
   *  <br><br>
   */
   ...
   *
   *  This is the default value applied to the
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#sentenceBump sentenceBump}
   *  field whenever a <code>SectionInfo</code> class is constructed.
   *  <br><br>
   */
   ...
   *
   *  This is the default value applied to the
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#depth depth}
   *  field whenever a <code>SectionInfo</code> class is constructed.
   *  <br><br>
   */
   ...
   *  which will be either
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#spell spell} or
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#noSpell noSpell}.
   *  <br><br>
   */
   ...
   *
   *  This value is used for the
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#spellFlag spellFlag} field
   ...
   *
   *  This is the default value applied to the
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#spellFlag spellFlag}
   *  field whenever a <code>SectionInfo</code> class is constructed.
   *  <br><br>
   */
   ...
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#parentIndex parentIndex},
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#noIndex noIndex},
   *  and {@link net.dataninja.ee.textIndexer.SectionInfo#index index}.
   *
   *  @.notes
   *  The value {@link net.dataninja.ee.textIndexer.SectionInfo#parentIndex parentIndex}
   ...
   *  which will be either
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#index index} or
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#index noIndex}.
   *  <br><br>
   */
   ...
   *
   *  @.notes
   *  The value {@link net.dataninja.ee.textIndexer.SectionInfo#parentSectionBump parentSectionBump}
   ...
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#parentSpell parentSpell},
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#noSpell noSpell},
   *  and {@link net.dataninja.ee.textIndexer.SectionInfo#spell spell}.
   *
   *  @.notes
   *  The value {@link net.dataninja.ee.textIndexer.SectionInfo#parentSpell parentSpell}
   ...
   *  which will be either
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#spell spell} or
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#spell noSpell}.
   *  <br><br>
   */
   ...
   * ee:meta attributes are encountered while indexing the current
   ...
   *
   *  @.notes
   *  See the {@link net.dataninja.ee.textIndexer.SectionInfo#defaultDepth},
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#defaultIndexFlag},
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#defaultSectionType},
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#defaultSectionBump},
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#defaultWordBoost},
   *  and
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#defaultSentenceBump}
   ...
   *  {@link net.dataninja.ee.textIndexer.SectionInfo#saveSectionBump() saveSectionBump()}.
   *  <br><br>
   */
