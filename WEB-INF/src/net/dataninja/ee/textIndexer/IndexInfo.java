...
public class IndexInfo 
{
   ...
   *       see {@link net.dataninja.ee.textIndexer.IndexInfo#chunkSize chunkSize}
   *       and {@link net.dataninja.ee.textIndexer.IndexInfo#chunkOvlp chunkOvlp}.
   */
  public int[] chunkAtt;
   ...
   * {@link net.dataninja.ee.textIndexer.IndexInfo#defaultChunkSize defaultChunkSize},
   * and the <code>chunkOvlp</code> entry to
   * {@link net.dataninja.ee.textIndexer.IndexInfo#defaultChunkOvlp defaultChunkOvlp}.
   */
  public IndexInfo() 
  {
   ...
   *  {@link net.dataninja.ee.textIndexer.IndexInfo#minChunkSize minChunkSize}
   *  value. <br><br>
   *
   *  @return     The resulting coerced chunkSize value. <br><br>
   *
   *  @.notes     This function also calls the
   *              {@link net.dataninja.ee.textIndexer.IndexInfo#setChunkOvlp(int) setChunkOvlp()}
   ...
   *  {@link net.dataninja.ee.textIndexer.IndexInfo#chunkOvlp chunkOvlp} attribute,
