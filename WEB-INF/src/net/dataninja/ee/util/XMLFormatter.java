 ...
 *
 *    formatter.setTabSize(4); // (Defaults to 2 spaces if not specified)
...
public class XMLFormatter
{
   ...
   *  {@link XMLFormatter#setBlankLineAfterTag(boolean) blankLineAfterTag(boolean enable) }
   *  function. <br><br>
   *
   *  @return
   ...
   */
  public boolean getBlankLineAfterTag () {
    return mBlankLineAfterTag;
  } // public getBlankLineAfterTag()
   ...
   */
  public boolean setBlankLineAfterTag (boolean enable)
  {
  ...
  } // public setBlankLineAfterTag( boolean enable )
   ...
   *  call the {@link XMLFormatter#setTabSize(int) tabSize(int newTabSize) }
   *  method.
   *
   *  @return
   ...
   *      container.
   */
  public int setTabSize (int newTabSize)
  {
    ...
    return oldTabSize;
  } // public setTabSize( int newTabSize )
   ...
   *  value.
   */
  public void setAttr (String attName, String attValue) {
    buf.append(" ");
    buf.append(attName);
    buf.append("=\"");
   ...
   *  value.
   */
  public void setAttr (String attName, int attValue) {
   ...
   */
  public void setAttr (String attName, float attValue) {
   ...
   *
   *  @.notes
   *       Use the {@link XMLFormatter#setAttr(String, String) setAttr() } method
