...
import net.dataninja.ee.textEngine.facet.DynamicGroupData;
import net.dataninja.ee.textEngine.facet.FacetSpec;
import net.dataninja.ee.textEngine.facet.GroupCounts;
import net.dataninja.ee.textEngine.facet.GroupData;
import net.dataninja.ee.textEngine.facet.ResultFacet;
import net.dataninja.ee.textEngine.facet.ResultGroup;
import net.dataninja.ee.textEngine.facet.StaticGroupData;
