...
import net.dataninja.ee.textEngine.facet.GroupSelector;
import net.dataninja.ee.textEngine.facet.MarkSelector;
import net.dataninja.ee.textEngine.facet.RootSelector;
import net.dataninja.ee.textEngine.facet.SelectorParser;
import net.dataninja.ee.util.EasyNode;
import net.dataninja.ee.util.FloatList;
...
public class QueryRequestParser 
{
  ...
  void parseFacetSpec(EasyNode el) 
  {
    ...
    for (int i = 0; i < el.nAttrs(); i++) 
    {
      ...
      else if (el.attrName(i).equalsIgnoreCase("includeEmptyGroups")) 
      {
        ...
        catch (net.dataninja.ee.textEngine.facet.ParseException e) {
          error(
    ...
    throws QueryGenException 
  {
    ...
    if (numeric) 
    {
      ...
      // ee special tokens. So be sure to exclude the whole area that marker
      // characters are in.
      //
      if (upper == null) {
        char[] tmp = new char[1];
