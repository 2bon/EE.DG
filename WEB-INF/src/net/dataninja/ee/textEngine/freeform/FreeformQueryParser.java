...
package net.dataninja.ee.textEngine.freeform;
...
public class FreeformQueryParser implements FreeformQueryParserConstants {
   ...
   * mirroring the XML that would be generated for an ee query.
   */
  public class FNode
  {
    ...
    /**
     * In ee, "not" is always implemented as AND-NOT. So make sure that
