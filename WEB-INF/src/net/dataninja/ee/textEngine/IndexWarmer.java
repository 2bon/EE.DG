...
public class IndexWarmer
{
   ...
   * 
   * @param xtfHome             Filesystem path to the ee home directory
    ...
    throws IOException
  {
    ...
    if (ent.curSearcher == null) 
    {
      ...
      if (ent.curSearcher == null)
        throw new RuntimeException("Error opening ee search index. Perhaps you need to run the textIndexer?");
    }
