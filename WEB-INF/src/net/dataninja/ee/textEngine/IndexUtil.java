...
import net.dataninja.ee.textIndexer.CrimsonBugWorkaround;
...
import net.dataninja.ee.util.DocTypeDeclRemover;
...
public class IndexUtil 
{
   ...
   * index's directory.
   *
   * @param xtfHome         File at the root of the ee directory tree
