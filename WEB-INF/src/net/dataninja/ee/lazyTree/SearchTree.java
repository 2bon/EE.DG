...
import net.dataninja.ee.textEngine.Snippet;
import net.dataninja.ee.util.CharMap;
import net.dataninja.ee.util.CheckingTokenStream;
...
public class SearchTree extends LazyDocument 
{
   ...
   * &lt;ee:snippets&gt; element, and under that creates on demand a
   * &lt;ee:snippet&gt; element for each snippet. These elements all
  ...
  /**
   * The top-level &lt;ee:snippet&gt; element.
   */
  SearchElementImpl topSnippetNode;

  /**
   * Snippet, hit, and term elements will all be marked with the ee
   * namespace, given by this URI: "http://dataninja.org/ee"
   */
  static final String xtfURI = "http://dataninja.org/ee";

  /** Namespace code for the ee namespace */
  int xtfNamespaceCode;

  /** Name fingerprint for &lt;ee:hit&gt; elements (includes namespace) */
  int hitElementFingerprint;

  /**
   * Name fingerprint for the &lt;ee:snippet&gt; element
   * (includes namespace)
   */
  ...
  /**
   * Name-code for all &lt;ee:hitCount&gt; attributes
   * (includes namespace)
   */
  int xtfHitCountAttrCode;

  /**
   * Name-code for all &lt;ee:firstHit&gt; attributes
   * (includes namespace)
   */
  ...
  /**
   * Adds the top-level &lt;ee:snippets&gt; element. If its children are
   ...
   *
   * It's overriden here to take the special case where "ee:hit" or
   * "ee:snippet" is specified.
   */
